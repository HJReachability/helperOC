function tutorial_BRS_with_traj_and_disturb_plus_obstacles_and_white_noise()
%% This runs numbers 2 & 4 & 7 & 8-> BRS with goal and traj and disturbance with obstacles plus white noise
...
%do Step8 here
HJIextraArgs.addGaussianNoiseStandardDeviation = [0.2; 0; 0];%[0; 0; 0.5];
...
%   xinit = [2, 2, -pi];
  ...
  % I have to define a different initial condition to reach it
  % it does not work properly though, it reaches the target but not at 
  % exactly time T.
  xinit = [1.5,1.5,-pi+0.5];
...
% plot 2
    ...
    TrajextraArgs.projDim = [1 1 1]; % computes optimal traj and visualizes
