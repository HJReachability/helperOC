function tutorial_BRS_with_Kene_method()
%% This runs number 2 -> BRS with goal and trajectory
...
HJIextraArgs.targetFunction = data0 < 0; % THIS NEEDS AN UPDATE. DEPENDS ON THE g FUNCTION OF THE PROBLEM.
HJIextraArgs.discountFactor = 0.0001; %delete previous plot as you update
HJIextraArgs.discountMode = 'Kene'; %delete previous plot as you update
...
% plot 2
    ...
    TrajextraArgs.projDim = [1 1 0]; % computes optimal traj and visualizes
